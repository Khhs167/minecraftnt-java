...
public class Chunk {
    ...
    public void floodFillIllumination(){
        ...
        //LOGGER.info("Reflooding light-maps took: " + (System.currentTimeMillis() - tile) + "ms");

        if((System.currentTimeMillis() - tile) > 1000){
            LOGGER.warn("Reflooding took a long time(over 1 second)! Are you sure your system is up to specs?");
        }
    ...
    private Vector2 convertUV(Vector2 uv, int textureID){
        ...
        float y = textureID / ClientMainHandler.TERRAIN_ATLAS_TEXTURES;
        float x = textureID - (y * ClientMainHandler.TERRAIN_ATLAS_TEXTURES);
    ...
    private boolean checkVoxel (Vector3I pos) {
        ...
        // If position is outside this chunk...
