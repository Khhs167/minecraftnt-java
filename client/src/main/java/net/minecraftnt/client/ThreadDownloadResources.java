...
public class ThreadDownloadResources extends Thread {
    ...
    private static final String ASSET_URL = "https://openability.tech/jimmster/minecraftnt/assets_beta/";
    ...
    private static void downloadAndSaveResource(URL url, long size, File output){
        ...
        try {
            ...
            LOGGER.info("Downloading {} ({}) [{} byte]", Paths.get(GameData.getResourceDirectory()).relativize(outPath), url, size);
